...
<li class="<?php bp_activity_css_class(); ?>" id="activity-<?php bp_activity_id(); ?>">
	...
	<div class="activity-content">
		...
		<div class="activity-header">
			...
			<?php
			/*
			 * Activity links contain text about how long ago the post was made.
			 * These are not guaranteed to be unique, and AHA's accessibility team
			 * requires that link text be unique. So, we remove the links
			 * (because there is no way without using the activity ID in the text to make it unique).
			 */
			bp_activity_action( array(
				'no_timestamp' => true )
			); ?>
			...
			<?php if ( is_user_logged_in() && bp_activity_can_comment() ) : ?>
				...
				<form action="<?php bp_activity_comment_form_action(); ?>" method="post" id="ac-form-<?php bp_activity_id(); ?>" class="ac-form"<?php bp_activity_comment_form_nojs_display(); ?>>
					...
					<div class="ac-reply-content">
						...
						<?php
						if ( function_exists( 'bp_nonce_field' ) ) {
							bp_nonce_field( 'new_activity_comment', '_wpnonce_new_activity_comment_' . bp_get_activity_id(), '_wpnonce_new_activity_comment' );
						} else {
